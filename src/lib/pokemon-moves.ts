...
const UNIVERSAL_EGG_MOVES: PokemonMove[] = [
  {
    ...
    name: "Dragon Dance",
    category: "egg",
    categoryLabel: "Egg / Breedable 🥚",
    type: "Dragon",
    power: 0,
    energyCost: ["Colorless"],
    description: "Raises Attack & Speed by 1 stage through primal rhythm.",
    isBreedable: true,
  },
  {
    id: "egg-outrage",
    ...
    type: "Dragon",
    power: 120,
    energyCost: ["Dragon", "Colorless"],
    description: "Rampages for 2-3 turns with overwhelming dragon fury.",
    isBreedable: true,
  },
  {
    id: "egg-bd",
    ...
    description: "Maximizes Attack stat instantly at the cost of 50% HP.",
    isBreedable: true,
  },
  {
    id: "egg-ap",
    ...
    power: 70,
    energyCost: ["Colorless", "Colorless"],
    description: "Attacks with prehistoric power. 10% chance to boost all stats.",
    isBreedable: true,
  },
  {
    id: "egg-crunch",
    ...
    type: "Dark",
    power: 80,
    energyCost: ["Dark", "Colorless"],
    description: "Crushes the target with sharp fangs. May lower Special Defense.",
    isBreedable: true,
  },
  {
    id: "egg-fb",
    ...
    description: "Cloaks the user in fierce flame and charges with immense recoil.",
    isBreedable: true,
  },
  {
    id: "egg-aj",
    ...
    power: 60,
    energyCost: ["Water"],
    description: "High-speed water strike that always strikes with priority +1.",
    isBreedable: true,
  },
  {
    id: "egg-vt",
    ...
    description: "Electrified tackle of legendary voltage. Inflicts recoil.",
    isBreedable: true,
  },
  {
    id: "egg-cc",
    ...
    description: "Unleashes rapid flurry attacks, slightly lowering defenses.",
    isBreedable: true,
  },
  {
    id: "egg-np",
    ...
    power: 0,
    energyCost: ["Dark"],
    description: "Concocts malicious schemes to sharply raise Special Attack.",
    isBreedable: true,
  },
  {
    id: "egg-counter",
    ...
    power: 100,
    energyCost: ["Fighting", "Colorless"],
    description: "Retaliates with double the damage taken from physical blows.",
    isBreedable: true,
  },
  {
    id: "egg-es",
    ...
    power: 80,
    energyCost: ["Colorless", "Colorless"],
    description: "Blinding instantaneous tackle with priority +2.",
    isBreedable: true,
  },
  {
    id: "egg-mc",
    ...
    power: 70,
    energyCost: ["Metal"],
    description: "Rakes the foe with hard steel claws. May raise Attack.",
    isBreedable: true,
  },
  {
    id: "egg-seed",
    ...
    power: 40,
    energyCost: ["Grass"],
    description: "Plants draining seeds that steal HP each turn.",
    isBreedable: true,
  },
  {
    id: "egg-baton",
    ...
    power: 0,
    energyCost: ["Colorless"],
    description: "Switches out while passing all stat boosts to the next Pokémon.",
    isBreedable: true,
  },
];
...
const STANDARD_MOVES: PokemonMove[] = [
  {
    ...
    description: "Intense blast of fire. 10% burn chance.",
    isBreedable: false,
  },
  {
    id: "std-fb",
    ...
    power: 120,
    energyCost: ["Fire", "Fire", "Colorless"],
    description: "Incinerates with a star-shaped inferno.",
    isBreedable: false,
  },
  {
    id: "std-hp",
    ...
    description: "Blasts a colossal volume of pressurized water.",
    isBreedable: false,
  },
  {
    id: "std-tb",
    ...
    description: "Strong bolt of lightning. 10% paralysis chance.",
    isBreedable: false,
  },
  {
    id: "std-sol",
    ...
    description: "Gathers intense solar energy and discharges in 1 devastating blast.",
    isBreedable: false,
  },
  {
    id: "std-eq",
    name: "Earthquake",
    category: "tm",
    categoryLabel: "Technical Machine 💿",
    type: "Fighting",
    power: 100,
    energyCost: ["Fighting", "Colorless"],
    description: "Shakes the tectonic plates, hitting all foes.",
    isBreedable: false,
  },
  {
    id: "std-ib",
    ...
    description: "Freezing sub-zero beam. 10% freeze chance.",
    isBreedable: false,
  },
  {
    id: "std-psy",
    ...
    description: "Telekinetic blast that may lower target Special Defense.",
    isBreedable: false,
  },
  {
    id: "std-sb",
    ...
    power: 80,
    energyCost: ["Psychic", "Colorless"],
    description: "Hurls a shadowy blob that weakens special defense.",
    isBreedable: false,
  },
  {
    id: "std-hb",
    ...
    description: "Extreme destructive laser beam. Highest raw kinetic damage.",
    isBreedable: false,
  },
];
  ...
  if (typeof localStorage !== "undefined") {
    try {
      localStorage.setItem(
        `${CUSTOM_MOVESET_STORAGE_KEY}:${cardId}`,
        JSON.stringify(moves.slice(0, 4)),
      );
    } catch (err) {
