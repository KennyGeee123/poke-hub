...
const GODS_EYE_SEEDS: GodsEyeNodeSeed[] = [
  {
    ...
    kind: "region",
    accent: "#ef4444",
    spawnHint: "Classic starters & birds",
  },
  {
    id: "johto",
    name: "Johto",
    subtitle: "Gen 2 · Violet–Olivine",
    xPct: 50,
    yPct: 50,
    lat: 35.01,
    lng: 135.77,
    ...
    kind: "region",
    accent: "#f59e0b",
    spawnHint: "Togepi nests & bells",
  },
  {
    id: "hoenn",
    name: "Hoenn",
    subtitle: "Gen 3 · Littleroot seas",
    xPct: 50,
    yPct: 50,
    lat: 26.21,
    lng: 127.68,
    eraId: "advanced_hoenn",
    kind: "region",
    accent: "#22c55e",
    spawnHint: "Surf & weather legends",
  },
  {
    id: "sinnoh",
    name: "Sinnoh",
    subtitle: "Gen 4 · Snowpoint north",
    xPct: 50,
    yPct: 50,
    lat: 43.06,
    lng: 141.35,
    eraId: "diamond_sinnoh",
    kind: "region",
    accent: "#38bdf8",
    spawnHint: "Mountain & lake spirits",
  },
  {
    id: "unova",
    name: "Unova",
    subtitle: "Gen 5 · Castelia",
    xPct: 50,
    yPct: 50,
    lat: 40.71,
    lng: -74.0,
    ...
    kind: "region",
    accent: "#a78bfa",
    spawnHint: "Urban + desert routes",
  },
  {
    id: "kalos",
    name: "Kalos",
    subtitle: "Gen 6 · Lumiose",
    xPct: 50,
    yPct: 50,
    lat: 48.86,
    lng: 2.35,
    ...
    kind: "region",
    accent: "#f472b6",
    spawnHint: "Fairy & mega vibes",
  },
  {
    id: "alola",
    name: "Alola",
    subtitle: "Gen 7 · Melemele",
    xPct: 50,
    yPct: 50,
    lat: 21.3,
    lng: -157.85,
    ...
    kind: "region",
    accent: "#fbbf24",
    spawnHint: "Island trial waters",
  },
  {
    id: "galar",
    name: "Galar",
    subtitle: "Gen 8 · Wyndon",
    xPct: 50,
    yPct: 50,
    lat: 51.5,
    lng: -0.12,
    ...
    kind: "region",
    accent: "#fb7185",
    spawnHint: "Dynamax dens",
  },
  {
    id: "paldea",
    name: "Paldea",
    subtitle: "Gen 9 · Mesagoza",
    xPct: 50,
    yPct: 50,
    lat: 40.4,
    lng: -3.7,
    ...
    kind: "region",
    accent: "#34d399",
    spawnHint: "Open-world terastals",
  },
  {
    id: "dresden",
    name: "Dresden Park",
    subtitle: "Rare nest · Chamblee GA",
    xPct: 31,
    yPct: 48,
    lat: 33.8824,
    lng: -84.2811,
    ...
    kind: "nest",
    accent: "#FFDE00",
    spawnHint: "5× rare / epic / legendary",
  },
  {
    id: "central-park",
    name: "Central Park",
    subtitle: "NYC dens & stops",
    xPct: 50,
    yPct: 50,
    lat: 40.7829,
    lng: -73.9654,
    ...
    kind: "city",
    accent: "#60a5fa",
    spawnHint: "Dense stops & lures",
  },
  {
    id: "akihabara",
    name: "Akihabara",
    subtitle: "Tokyo raid district",
    xPct: 50,
    yPct: 50,
    lat: 35.6984,
    lng: 139.7731,
    ...
    kind: "city",
    accent: "#f87171",
    spawnHint: "Legendary raid pressure",
  },
  {
    id: "santa-monica",
    name: "Santa Monica",
    subtitle: "Pier water biome",
    xPct: 50,
    yPct: 50,
    lat: 34.01,
    lng: -118.5,
    ...
    kind: "landmark",
    accent: "#2dd4bf",
    spawnHint: "Water & rare surf",
  },
  {
    id: "sydney",
    name: "Sydney Quay",
    subtitle: "Oceanic event hub",
    xPct: 50,
    yPct: 50,
    lat: -33.86,
    lng: 151.21,
    ...
    kind: "landmark",
    accent: "#818cf8",
    spawnHint: "Oceanic event spawns",
  },
  {
    id: "indigo",
    name: "Indigo Plateau",
    subtitle: "Hall of Fame gate",
    xPct: 50,
    yPct: 22,
    lat: 36.2,
    lng: 140.1,
    ...
    kind: "landmark",
    accent: "#eab308",
    spawnHint: "Elite Four pressure",
  },
  {
    id: "hisui",
    name: "Hisui Wilds",
    subtitle: "Obsidian Fieldlands",
    xPct: 50,
    yPct: 50,
    lat: 43.8,
    lng: 142.4,
