    ...
    <div className="pad">
      ...
      <div className="pv-detail-layout">
        <div className="pv-detail-left">
            ...
            >
              ...
              <div
                style={{
                  ...
                  padding: "6px 10px",
                  background:
                    "linear-gradient(135deg, rgba(14, 165, 233, 0.92), rgba(99, 102, 241, 0.92))",
                  borderRadius: 8,
                  fontSize: 10,
                  fontWeight: 800,
                  color: "#ffffff",
          ...
          >
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <div
                  style={{
                    fontSize: 14,
                    fontWeight: 700,
                    color: gradeMeta.isSlab ? "#4ade80" : "var(--t2)",
                  }}
                >
            ...
            {gradeMeta.isSlab ? (
              ...
              >
                <div
                  style={{ display: "flex", justifyContent: "space-between", color: "var(--t2)" }}
                >
                ...
                <div
                  style={{
                    ...
                    paddingTop: 4,
                    color: gradedVal.estimatedProfit >= 0 ? "#4ade80" : "#f87171",
                  }}
                >
                  <span>Grading Profit / ROI:</span>
                  <span>
                    {gradedVal.estimatedProfit >= 0 ? "+" : ""}
                    {formatPrice(gradedVal.estimatedProfit)} ({gradedVal.estimatedRoiPct}%)
                  </span>
                </div>
              </div>
            ) : (
        ...
        <div className="pv-detail-right">
          ...
          >
            <button
              ...
              style={{
                ...
                borderBottom:
                  activeTab === "pricing" ? "2px solid var(--neon-yellow, #fbbf24)" : "none",
                padding: "4px 8px",
                cursor: "pointer",
                fontSize: 12,
              }}
            ...
            <button
              ...
              style={{
                ...
                borderBottom:
                  activeTab === "ai_inspector" ? "2px solid var(--neon-cyan, #38bdf8)" : "none",
                padding: "4px 8px",
                cursor: "pointer",
                fontSize: 12,
              }}
          ...
          {activeTab === "ai_inspector" ? (
            ...
            <div
              style={{
                padding: 16,
                background:
                  "linear-gradient(135deg, rgba(14, 165, 233, 0.08), rgba(15, 23, 42, 0.8))",
            ...
            >
              ...
              >
                <div>
                  <div
                    style={{ fontSize: 13, fontWeight: 800, color: "#38bdf8", letterSpacing: 1 }}
                  >
                    🔬 AI PRE-GRADE PREDETERMINATION ENGINE
                  </div>
                  <div style={{ fontSize: 11, color: "var(--t3)" }}>
                    Analyze raw ungraded card online to predict PSA 10 / 9 probability & expected
                    ROI
                  </div>
                </div>
                <span
                  style={{
                    ...
                    fontWeight: 800,
                    background:
                      preGradeAnalysis.expectedNetGain >= 20
                        ? "rgba(34,197,94,0.2)"
                        : "rgba(234,179,8,0.2)",
                  ...
                  {UNGRADED_QUALITIES.map((q) => (
                    <button
                      ...
                      onClick={() => {
                        setInspectQuality(q);
                        if (q === "raw_mint") {
                          setCenteringScore(96);
                          setCornersScore(98);
                          setEdgesScore(96);
                          setSurfaceScore(97);
                        } else if (q === "raw_nm") {
                          setCenteringScore(90);
                          setCornersScore(92);
                          setEdgesScore(91);
                          setSurfaceScore(92);
                        } else if (q === "raw_lp") {
                          setCenteringScore(82);
                          setCornersScore(80);
                          setEdgesScore(78);
                          setSurfaceScore(84);
                        } else if (q === "raw_mp") {
                          setCenteringScore(70);
                          setCornersScore(65);
                          setEdgesScore(60);
                          setSurfaceScore(68);
                        } else {
                          setCenteringScore(50);
                          setCornersScore(45);
                          setEdgesScore(40);
                          setSurfaceScore(45);
                        }
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 18,
                      fontWeight: 900,
                      color: preGradeAnalysis.probabilities.psa10 >= 50 ? "#4ade80" : "var(--t1)",
                    }}
                  >
              ...
              >
                <div>
                  <div style={{ fontSize: 10, color: "var(--t3)" }}>
                    ESTIMATED GROSS VALUE AFTER GRADING
                  </div>
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 10, color: "var(--t3)" }}>
                    PROJECTED NET PROFIT (AFTER RAW + $19.99 FEE)
                  </div>
                  <div
                    style={{
                      fontSize: 18,
                      fontWeight: 900,
                      color: preGradeAnalysis.expectedNetGain >= 0 ? "#4ade80" : "#f87171",
                    }}
                  >
                    {preGradeAnalysis.expectedNetGain >= 0 ? "+" : ""}
                    {formatPrice(preGradeAnalysis.expectedNetGain)}
                  </div>
                </div>
              </div>
            </div>
          ...
          {card.rarity && (
            <span
              className="pv-rar-badge"
              style={{
                color: getRarityColor(card.rarity),
                borderColor: getRarityColor(card.rarity) + "55",
                background: getRarityColor(card.rarity) + "18",
              }}
            >
              {card.rarity}
            </span>
          ...
          {card.hp && (
            <div style={{ marginBottom: 12, fontSize: 12, color: "var(--t2)" }}>
              HP{" "}
              <span style={{ color: "#ff6b6b", fontWeight: 900, fontSize: 18, marginLeft: 4 }}>
                {card.hp}
              </span>
            </div>
          )}
                ...
                {[
                  ...
                  .map(([k, v]) => (
                    ...
                    >
                      ...
                      <div style={{ color: "#60a5fa", fontWeight: 700, fontFamily: "monospace" }}>
...
function CardVariantPriceMatrix({
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <table className="pv-price-tbl">
        ...
        <tbody>
          {prints.length ? (
            ...
            <tr>
              <td colSpan={5} style={{ color: "var(--t3)" }}>
                No print-variant quotes yet — RAW / slab ladders still apply.
              </td>
            </tr>
          )}
        </tbody>
      ...
      <div className="pv-section-title" style={{ marginTop: 12 }}>
        RAW CONDITIONS
      </div>
      <table className="pv-price-tbl">
        <thead>
  ...
  if (loading)
    return (
      <div className="pv-panel">
        <div className="pv-panel-title">POKÉDEX</div>
        <div style={{ fontSize: 11, color: "var(--t3)", marginTop: 8 }}>Loading PokeAPI…</div>
      </div>
    );
  if (!data) return null;
  ...
  return (
    <div className="pv-panel">
      ...
      <div className="pv-pokedex-grid">
        ...
        <div>
          {data.genus && (
            <div style={{ fontSize: 11, color: "var(--gold)", letterSpacing: 1, marginBottom: 4 }}>
              {data.genus.toUpperCase()}
            </div>
          )}
          {data.flavorText && (
            <div
          ...
          <div
            style={{ display: "flex", gap: 14, fontSize: 11, color: "var(--t2)", marginBottom: 10 }}
          >
            <div>
              <span style={{ color: "var(--t3)" }}>HT</span> {(data.height / 10).toFixed(1)} m
            </div>
            <div>
              <span style={{ color: "var(--t3)" }}>WT</span> {(data.weight / 10).toFixed(1)} kg
            </div>
          </div>
          {data.stats.map((s) => (
            <div className="pv-stat-bar" key={s.name}>
              <div className="pv-stat-bar-lbl">{s.name.replace("special-", "sp.")}</div>
              <div className="pv-stat-bar-bar">
                <div
                  className="pv-stat-bar-fill"
                  style={{ width: `${Math.min(100, (s.base / maxStat) * 100)}%` }}
                />
              </div>
...
function AltArtworksPanel({ card }: { card: TCGCard }) {
  ...
  if (!arts)
    return (
      <div className="pv-panel">
        <div className="pv-panel-title">INTERNATIONAL ARTWORKS</div>
        <div style={{ fontSize: 11, color: "var(--t3)", marginTop: 8 }}>Searching TCGdex…</div>
      </div>
    );
    ...
    <div className="pv-panel">
      ...
      {data?.summary && (
        <div className="pv-ebay-summary">
          <div className="pv-ebay-stat">
            <div className="pv-ebay-stat-lbl">SOLD</div>
            <div className="pv-ebay-stat-val" style={{ color: "var(--t1)" }}>
              {data.summary.count}
            </div>
          </div>
          <div className="pv-ebay-stat">
            <div className="pv-ebay-stat-lbl">MEDIAN</div>
            <div className="pv-ebay-stat-val">${data.summary.median.toFixed(0)}</div>
          </div>
          <div className="pv-ebay-stat">
            <div className="pv-ebay-stat-lbl">AVG</div>
            <div className="pv-ebay-stat-val">${data.summary.avg.toFixed(0)}</div>
          </div>
          <div className="pv-ebay-stat">
            <div className="pv-ebay-stat-lbl">RANGE</div>
            <div className="pv-ebay-stat-val" style={{ fontSize: 11 }}>
              ${data.summary.min.toFixed(0)}-${data.summary.max.toFixed(0)}
            </div>
          </div>
        </div>
      )}
      {data?.listings.slice(0, 6).map((l, i) => (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="pv-ebay-row"
          style={{ textDecoration: "none", color: "inherit" }}
        >
          {l.image ? (
            <img src={l.image} alt="" loading="lazy" />
          ) : (
            <div style={{ width: 40, height: 40, background: "var(--s2)", borderRadius: 4 }} />
          )}
          <div>
...
function BulbapediaPanel({ cardName }: { cardName: string }) {
  ...
  if (loading)
    return (
      <div className="pv-bulba-panel">
        <div className="pv-bulba-head">
          <span>📖</span>BULBAPEDIA
        </div>
  ...
  return (
    <div className="pv-bulba-panel">
      <div className="pv-bulba-head">
        <span>📖</span>BULBAPEDIA · {info.title}
      </div>
      <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 12, color: "var(--t2)", lineHeight: 1.6, marginBottom: 8 }}>
            {info.extract || "No summary available."}
          </p>
          <a
            href={info.url}
            target="_blank"
            rel="noreferrer"
            style={{ color: "var(--gold)", fontSize: 11, fontWeight: 700, letterSpacing: 1 }}
          >
            READ FULL ENTRY →
          </a>
        </div>
